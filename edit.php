            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="dashboard.php" class="waves-effect"><i class="ti-home"></i><span> Edit Data </span></span></a>
                        </li>

                        <li>
                            <a href="datanilai.php" class="waves-effect"></i><span> Edit Data </span></a>
                        </li>
...
<div class="container-fluid">
	...
	$data = mysqli_query($koneksi,"select * from ip where semester='$semester'");
